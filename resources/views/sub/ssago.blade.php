...
<head>
  ...
  <title>싸고좋은 인테리어 가능하다!!</title>
  <link rel="shortcut icon" href="/images/favicon.ico">
  <link rel="stylesheet" href="../css/ssago.css">
...
<body>
  <div class="wrap">
    ...
    <div class="container">
      <img src="/images/sub/banner.png" alt="싸고좋아배너">
      <div>
        <h2>싸고 좋은 인테리어 당연히 가능합니다.</h2>
        <p>테리어중개업체에게 돌아가는 인테리어업체에서 받는 중개수수료 5%를 <br>
          플랫폼 운영비 2%만 남기고 소비자에게 돌려 드립니다.
        </p>
      </div>
      <div>
        <a href="../counsel/service.html">
          <img src="/images/sub/service.png" alt="서비스선택이미지">
        </a>
      </div>
      <div>
        <p>
          소비자는 원하는 서비스를 받을 수 있습니다. <br>
          <span>인테리어 가격은 줄어들고 품질은 좋아지는 인테리어 소비자 선택 옵션.
          </span><br>
          원하는 서비스만 골라서 선택하세요. <br>
          인테리어가 싸고 좋아집니다.
        </p>
      </div>
    </div>
